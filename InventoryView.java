...
import java.util.*;
class InventoryView extends JPanel implements ActionListener
{
	JInternalFrame ViewBill = new JInternalFrame("View all Inventory Details",true,true,true,true);
	...
	String com = new String("Inventory_ID");
	String com1;
	String filds[] = {
					"Inventory_ID", "Style_ID", "Details", "Vendor_Name","Vendor_ID", "In_Date", "Gold", "Gold_wt", "Stone_Type","Stone_Weight", "Stone_numbers", "Stone_Wt", "Stone_Name", "Current_status"
				 }; 
	...
	public JInternalFrame InventoryViewFrame(JDesktopPane desktop)
	{
